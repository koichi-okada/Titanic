...
def modeller(train_dataset=None, new_input=False, load_saved_model=True, save_model=True, plot_results=False):
    """
    ...
    # else do the full training
        ...
        dataset = pd.read_csv(directory + r'/ml_dataset/titanic.csv')
        dataset = data_cleansing(dataset)
...
# uui = uzu_uzu_index_predictor(load_saved_model=True)
#    this doesn't work
# uui = uzu_uzu_index_predictor(train_dataset=None, new_input=False, load_saved_model=True, save_model=True, plot_results=False)